  ...
  return (
    <main className="h-screen w-screen flex flex-col items-center justify-center"> 
      <motion.div 
        ...
        className="relative h-40 w-56 sm:h-72 sm:w-96"
      >
        <Image
          src="/Logo-2.png"
          alt="Next.js Logo"
      ...
      <motion.span 
        ...
        className="max-w-6xl text-center text-sm md:text-lg sm:text-lg text-neutral-400 antialiased tracking-wide  leading-6 md:leading-7 lg:leading-7 font-sans p-4 mt-2 md:mt-8"
      >
